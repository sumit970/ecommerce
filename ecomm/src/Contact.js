...
const Contact = () => {
  ...
  const [contct, setcontct] = useState(true)
  ...
  return(
    ...
    <div className="container">
      <div className="contact-form">
        <form
          action="https://formspree.io/f/xvonbyno"
          method="POST"
          ...
          <input type="submit" onClick={()=>setcontct(!contct)} value="send" />
        </form>
      </div>
    </div>
  </Wrapper>
...
if(!contct) {
  ...
  <div className="flex flex-row items-center justify-center pt-10">
    ...
    <p> Hey! Thanks for submitting. We will get back to you shortly..</p>
